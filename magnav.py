...
shc_fn = './data/IGRF13.shc' # Default shc file

# Geomagnetic reference radius:
RE = 6371.2 # km, 地磁参考半径

# World Geodetic System 84 parameters:
WGS84_e2 = 0.00669437999014 # 扁率，
WGS84_a  = 6378.137 # km， 半长轴，赤道半径 
...
def geod2geoc(gdlat, height, Bn, Bu):
    """
    Convert from geocentric to geodetic coordinates #地心坐标 转换为 大地坐标
